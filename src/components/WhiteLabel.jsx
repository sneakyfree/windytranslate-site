...
export default function WhiteLabel() {
  ...
  const verticals = [
    ...
    },
    {
      ...
      problem: 'Cloud-based generic translation APIs raise data sovereignty concerns. Sending Social Security numbers through a third-party cloud API? Immigration case details through external translation services? Legal and security teams say no.',
