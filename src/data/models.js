...
export const models = [
  // Marco Polo Pack — Top global commerce pairs
  {
    ...
    accuracy: '98.5', genericAccuracy: '82.1', size: '420MB',
  ...
  },
  {
    ...
    accuracy: '97.2', genericAccuracy: '76.8', size: '580MB',
  ...
  },
  {
    ...
    accuracy: '96.8', genericAccuracy: '73.2', size: '510MB',
  ...
  },
  {
    ...
    accuracy: '97.5', genericAccuracy: '78.3', size: '460MB',
  ...
  },
  {
    ...
    accuracy: '98.2', genericAccuracy: '84.5', size: '390MB',
  ...
  },
  {
    ...
    accuracy: '98.0', genericAccuracy: '83.2', size: '410MB',
  ...
  },
  {
    ...
    accuracy: '97.9', genericAccuracy: '83.8', size: '440MB',
  ...
  },
  {
    ...
    accuracy: '96.5', genericAccuracy: '74.2', size: '620MB',
  ...
  },
  {
    ...
    accuracy: '97.1', genericAccuracy: '79.6', size: '530MB',
  ...
  },
  {
    ...
    accuracy: '96.8', genericAccuracy: '75.4', size: '590MB',
  ...
  // Traveler Pack
  {
    ...
    accuracy: '98.1', genericAccuracy: '84.7', size: '380MB',
  ...
  },
  {
    ...
    accuracy: '96.2', genericAccuracy: '71.8', size: '520MB',
  ...
  },
  {
    ...
    accuracy: '96.8', genericAccuracy: '73.5', size: '490MB',
  ...
  },
  {
    ...
    accuracy: '97.0', genericAccuracy: '76.9', size: '450MB',
  ...
  },
  {
    ...
    accuracy: '97.3', genericAccuracy: '78.2', size: '430MB',
  ...
  },
  {
    ...
    accuracy: '98.0', genericAccuracy: '85.1', size: '370MB',
  ...
  },
  {
    ...
    accuracy: '97.8', genericAccuracy: '84.3', size: '360MB',
  ...
  },
  {
    ...
    accuracy: '96.9', genericAccuracy: '75.6', size: '480MB',
  ...
  {
    id: 'en-es-med', name: 'EN↔ES Medical', category: 'medical',
    accuracy: '96.3', genericAccuracy: '74.1', size: '680MB',
  ...
  {
    id: 'en-zh-med', name: 'EN↔ZH Medical', category: 'medical',
    accuracy: '97.2', genericAccuracy: '71.8', size: '750MB',
  ...
  {
    id: 'en-ar-med', name: 'EN↔AR Medical', category: 'medical',
    accuracy: '96.5', genericAccuracy: '69.4', size: '720MB',
    pairs: ['en→ar', 'ar→en'], downloads: '210K', domain: 'Medical',
    trainingData: '1.4M medical documents',
  },
  {
    id: 'en-fr-med', name: 'EN↔FR Medical', category: 'medical',
    accuracy: '97.8', genericAccuracy: '76.3', size: '650MB',
    pairs: ['en→fr', 'fr→en'], downloads: '290K', domain: 'Medical',
    trainingData: '1.9M medical documents',
  },
  {
    id: 'en-de-med', name: 'EN↔DE Medical', category: 'medical',
    accuracy: '97.5', genericAccuracy: '75.8', size: '680MB',
  ...
  {
    id: 'en-es-leg', name: 'EN↔ES Legal', category: 'legal',
    accuracy: '97.8', genericAccuracy: '72.4', size: '720MB',
  ...
  {
    id: 'en-zh-leg', name: 'EN↔ZH Legal', category: 'legal',
    accuracy: '97.2', genericAccuracy: '70.1', size: '790MB',
    pairs: ['en→zh', 'zh→en'], downloads: '165K', domain: 'Legal',
    trainingData: '380K legal documents',
  },
  {
    id: 'en-fr-leg', name: 'EN↔FR Legal', category: 'legal',
    accuracy: '97.9', genericAccuracy: '74.6', size: '690MB',
    pairs: ['en→fr', 'fr→en'], downloads: '180K', domain: 'Legal',
    trainingData: '480K legal documents',
  },
  {
    id: 'en-de-leg', name: 'EN↔DE Legal', category: 'legal',
    accuracy: '97.8', genericAccuracy: '72.4', size: '710MB',
  ...
  {
    id: 'en-pt-leg', name: 'EN↔PT Legal', category: 'legal',
    accuracy: '97.4', genericAccuracy: '73.8', size: '700MB',
  ...
  {
    id: 'en-zh-tech', name: 'EN↔ZH Technical', category: 'technical',
    accuracy: '98.1', genericAccuracy: '76.9', size: '820MB',
  ...
  {
    id: 'en-ja-tech', name: 'EN↔JA Technical', category: 'technical',
    accuracy: '97.6', genericAccuracy: '74.5', size: '860MB',
  ...
  {
    id: 'en-de-tech', name: 'EN↔DE Technical', category: 'technical',
    accuracy: '97.9', genericAccuracy: '77.3', size: '730MB',
    pairs: ['en→de', 'de→en'], downloads: '340K', domain: 'Technical',
    trainingData: '890K technical docs',
  },
  {
    id: 'en-ru-tech', name: 'EN↔RU Technical', category: 'technical',
    accuracy: '97.4', genericAccuracy: '75.2', size: '780MB',
    pairs: ['en→ru', 'ru→en'], downloads: '290K', domain: 'Technical',
    trainingData: '760K technical docs',
  },
  {
    id: 'en-ko-tech', name: 'EN↔KO Technical', category: 'technical',
    accuracy: '97.5', genericAccuracy: '74.8', size: '810MB',
    pairs: ['en→ko', 'ko→en'], downloads: '270K', domain: 'Technical',
    trainingData: '680K technical docs',
  },
  {
    id: 'en-fr-tech', name: 'EN↔FR Technical', category: 'technical',
    accuracy: '97.8', genericAccuracy: '78.1', size: '710MB',
